    ...
    _createClass(Stopwatch, [{
        ...
        value: function render() {
            ...
            return React.createElement('div', {}, React.createElement('div', { className: 'nav' }, React.createElement('button', { onClick: function onClick() {
                ...
                } }, 'Delete List')), React.createElement('div', { id: 'container', className: 'container' }, React.createElement('div', { id: 'stopwatch', className: 'stopwatch' }, this.format())), React.createElement('ul', { id: 'results', className: 'results' }));
        }
    }]);
